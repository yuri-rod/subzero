...
def build_parser() -> argparse.ArgumentParser:
    ...
    worker.add_argument("action", nargs="?", default="serve",
                        choices=["serve", "start", "stop", "shutdown", "status", "contribute", "jobs", "sweep", "coverage", "audits", "console", "repl"],
                        help="action to perform (default: serve; 'console' opens an interactive shell)")
